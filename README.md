...
Gitential uses [libgit2](https://libgit2.github.com/) to extract


Please feel free to request datasets for other repositories in the issues!
...
<table>
  ...
  <tbody>
    ...
    <tr>
      <th>blame_author_email</th>
      <td>string</td>
      <td>The churned author's email address</td>
    </tr>
    <tr>
      <th>blame_author_time</th>
      <td>datetime</td>
